...
#>  eta1                      -0.3000      0.0956   -3.1382    0.0017
#>  eta2                       0.4999      0.0964    5.1842    0.0000
#>  eta6                       0.2501      0.1240    2.0163    0.0438
#>  Resid_eta6                 0.9784      0.2431    4.0247    0.0001
#> 
#>   Dependent construct: 'eta6'
#> 
#>  Independent construct    Estimate  Std. error   t-stat.   p-value
#>  eta3                       0.4999      0.0512    9.7633    0.0000
#>  eta4                       0.2501      0.0528    4.7377    0.0000
#>  eta5                       0.5001      0.0931    5.3748    0.0000
#>  Resid_eta5                -0.0056      0.1331   -0.0420    0.9665
#> ________________________________________________________________________________
```
