...
#>  eta1                      -0.3000      0.1254   -2.3925    0.0167
#>  eta2                       0.4999      0.0863    5.7933    0.0000
#>  eta6                       0.2501      0.1365    1.8318    0.0670
#>  Resid_eta6                 0.9784      0.2744    3.5662    0.0004
#> 
#>   Dependent construct: 'eta6'
#> 
#>  Independent construct    Estimate  Std. error   t-stat.   p-value
#>  eta3                       0.4999      0.0544    9.1958    0.0000
#>  eta4                       0.2501      0.0494    5.0587    0.0000
#>  eta5                       0.5001      0.1018    4.9145    0.0000
#>  Resid_eta5                -0.0056      0.1274   -0.0438    0.9650
#> ________________________________________________________________________________
```
