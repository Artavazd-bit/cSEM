...
#>  eta1                      -0.3000      0.0969   -3.0965    0.0020
#>  eta2                       0.4999      0.0915    5.4654    0.0000
#>  eta6                       0.2501      0.1249    2.0020    0.0453
#>  Resid_eta6                 0.9784      0.3086    3.1708    0.0015
#> 
#>   Dependent construct: 'eta6'
#> 
#>  Independent construct    Estimate  Std. error   t-stat.   p-value
#>  eta3                       0.4999      0.0615    8.1284    0.0000
#>  eta4                       0.2501      0.0509    4.9109    0.0000
#>  eta5                       0.5001      0.0960    5.2108    0.0000
#>  Resid_eta5                -0.0056      0.1363   -0.0410    0.9673
#> ________________________________________________________________________________
```
