...
#>  eta1                      -0.3000      0.0895   -3.3508    0.0008
#>  eta2                       0.4999      0.0889    5.6219    0.0000
#>  eta6                       0.2501      0.1199    2.0863    0.0369
#>  Resid_eta6                 0.9784      0.2418    4.0465    0.0001
#> 
#>   Dependent construct: 'eta6'
#> 
#>  Independent construct    Estimate  Std. error   t-stat.   p-value
#>  eta3                       0.4999      0.0514    9.7211    0.0000
#>  eta4                       0.2501      0.0532    4.7023    0.0000
#>  eta5                       0.5001      0.0997    5.0154    0.0000
#>  Resid_eta5                -0.0056      0.1322   -0.0423    0.9663
#> ________________________________________________________________________________
```
