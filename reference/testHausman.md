...
#>  eta1                      -0.3000      0.1130   -2.6548    0.0079
#>  eta2                       0.4999      0.0939    5.3208    0.0000
#>  eta6                       0.2501      0.1293    1.9338    0.0531
#>  Resid_eta6                 0.9784      0.2649    3.6940    0.0002
#> 
#>   Dependent construct: 'eta6'
#> 
#>  Independent construct    Estimate  Std. error   t-stat.   p-value
#>  eta3                       0.4999      0.0559    8.9357    0.0000
#>  eta4                       0.2501      0.0587    4.2585    0.0000
#>  eta5                       0.5001      0.0987    5.0672    0.0000
#>  Resid_eta5                -0.0056      0.1378   -0.0405    0.9677
#> ________________________________________________________________________________
```
