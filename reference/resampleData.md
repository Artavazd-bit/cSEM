...
#>   ..$ imag1: int [1:250] 9 8 7 7 7 9 9 10 9 8 ...
#>   ..$ imag2: int [1:250] 10 8 5 8 7 8 9 8 9 8 ...
#>   ..$ imag3: int [1:250] 9 8 7 8 7 9 9 8 10 8 ...
#>   .. [list output truncated]
#>  $ :'data.frame':    250 obs. of  27 variables:
#>   ..$ imag1: int [1:250] 8 9 8 7 8 8 7 9 8 8 ...
#>   ..$ imag2: int [1:250] 7 10 4 10 4 10 8 8 8 9 ...
#>   ..$ imag3: int [1:250] 7 10 3 10 3 8 8 8 8 10 ...
#>   .. [list output truncated]
#>  $ :'data.frame':    250 obs. of  27 variables:
#>   ..$ imag1: int [1:250] 8 8 5 7 8 10 8 8 10 8 ...
#>   ..$ imag2: int [1:250] 4 7 7 5 9 10 6 9 10 10 ...
#>   ..$ imag3: int [1:250] 3 10 8 7 9 10 3 9 10 10 ...
#>   .. [list output truncated]
#>   [list output truncated]
...
#>   .. ..$ x1   : num [1:10] 0.852 1.177 -0.626 0.193 -0.628 ...
#>   .. ..$ x2   : num [1:10] -0.9473 0.529 -0.0422 -0.6105 0.7362 ...
#>   .. ..$ group: chr [1:10] "male" "male" "female" "male" ...
#>   ..$ 2 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] -0.7525 -0.1804 0.0377 -0.6652 0.1837 ...
#>   .. ..$ x2   : num [1:10] 0.463 0.16 0.192 0.96 2.375 ...
#>   .. ..$ group: chr [1:10] "male" "female" "female" "female" ...
#>   ..$ 3 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] 0.412 -0.152 -0.977 0.903 -0.735 ...
#>   .. ..$ x2   : num [1:10] -0.0186 2.0113 0.6931 2.4544 -0.3313 ...
#>   .. ..$ group: chr [1:10] "male" "male" "male" "female" ...
#>   .. [list output truncated]
#>  $ :List of 10
#>   ..$ 1 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] -0.665 -0.783 -0.489 -2.399 -0.23 ...
#>   .. ..$ x2   : num [1:10] 0.9604 -0.2047 0.709 0.0099 -0.4629 ...
#>   .. ..$ group: chr [1:10] "female" "female" "female" "male" ...
#>   ..$ 2 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] 0.596 -0.375 1.779 0.611 0.629 ...
#>   .. ..$ x2   : num [1:10] 0.549 -0.868 -1.094 -1.405 -0.14 ...
#>   .. ..$ group: chr [1:10] "male" "male" "male" "male" ...
#>   ..$ 3 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] -0.3926 -0.0841 1.1762 0.0749 0.6029 ...
#>   .. ..$ x2   : num [1:10] 0.499 -3.311 -0.126 -0.81 0.449 ...
#>   .. ..$ group: chr [1:10] "female" "female" "female" "female" ...
#>   .. [list output truncated]
#>  $ :List of 10
#>   ..$ 1 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] 0.412 0.382 1.185 1.177 0.794 ...
#>   .. ..$ x2   : num [1:10] -0.0186 0.5385 -0.1608 0.529 0.3624 ...
#>   .. ..$ group: chr [1:10] "male" "female" "male" "male" ...
#>   ..$ 2 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] -0.755 1.377 0.496 -0.264 -0.084 ...
#>   .. ..$ x2   : num [1:10] 0.489 1.092 1.373 -1.196 -0.708 ...
#>   .. ..$ group: chr [1:10] "female" "male" "male" "female" ...
#>   ..$ 3 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] -0.752 0.634 -0.319 -0.375 1.871 ...
#>   .. ..$ x2   : num [1:10] 0.463 0.97 -0.501 -0.868 -1.049 ...
#>   .. ..$ group: chr [1:10] "male" "male" "male" "male" ...
#>   .. [list output truncated]
#>   [list output truncated]
...
#> Warning: data length is not a multiple of split variable
#> Warning: data length is not a multiple of split variable
#> Warning: UNRELIABLE VALUE: One of the ‘future.apply’ iterations (‘future_lapply-1’) unexpectedly generated random numbers without declaring so. There is a risk that those random numbers are not statistically sound and the overall results might be invalid. To fix this, specify 'future.seed=TRUE'. This ensures that proper, parallel-safe random numbers are produced via a parallel RNG method. To disable this check, use 'future.seed = NULL', or set option 'future.rng.onMisuse' to "ignore". [future ‘future_lapply-1’ (a1a9674ccce6e58e04fe7262d2b8d096-18); on a1a9674ccce6e58e04fe7262d2b8d096@runnervmgx7h7<7442>]
