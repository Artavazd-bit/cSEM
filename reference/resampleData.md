...
#>   ..$ imag1: int [1:250] 8 7 6 9 9 9 10 7 10 8 ...
#>   ..$ imag2: int [1:250] 6 4 6 8 9 10 10 8 10 7 ...
#>   ..$ imag3: int [1:250] 6 5 7 9 10 10 8 8 10 7 ...
#>   .. [list output truncated]
#>  $ :'data.frame':    250 obs. of  27 variables:
#>   ..$ imag1: int [1:250] 8 10 6 8 8 6 8 7 9 3 ...
#>   ..$ imag2: int [1:250] 8 10 8 6 10 8 6 10 9 4 ...
#>   ..$ imag3: int [1:250] 8 10 8 7 8 8 6 10 9 2 ...
#>   .. [list output truncated]
#>  $ :'data.frame':    250 obs. of  27 variables:
#>   ..$ imag1: int [1:250] 10 6 8 9 9 6 6 5 6 9 ...
#>   ..$ imag2: int [1:250] 9 8 8 8 7 8 6 5 7 10 ...
#>   ..$ imag3: int [1:250] 9 8 8 8 8 8 4 7 7 9 ...
#>   .. [list output truncated]
#>   [list output truncated]
...
#>   .. ..$ x1   : num [1:10] -0.2607 -0.0469 -2.3483 0.5964 0.611 ...
#>   .. ..$ x2   : num [1:10] 0.286 1.366 -0.341 0.549 -1.405 ...
#>   .. ..$ group: chr [1:10] "female" "female" "male" "male" ...
#>   ..$ 2 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] -0.0193 -0.3926 0.3055 -0.0062 1.2923 ...
#>   .. ..$ x2   : num [1:10] -0.409 0.499 0.792 1.845 -0.805 ...
#>   .. ..$ group: chr [1:10] "female" "female" "female" "female" ...
#>   ..$ 3 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] -0.279 -0.375 1.177 -0.665 -0.62 ...
#>   .. ..$ x2   : num [1:10] 2.196 -0.868 0.529 0.96 -1.57 ...
#>   .. ..$ group: chr [1:10] "female" "male" "male" "female" ...
#>   .. [list output truncated]
#>  $ :List of 10
#>   ..$ 1 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] -0.735 0.611 -0.264 0.837 0.852 ...
#>   .. ..$ x2   : num [1:10] -0.331 -1.405 -1.196 0.796 -0.947 ...
#>   .. ..$ group: chr [1:10] "female" "male" "female" "female" ...
#>   ..$ 2 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] -0.0479 -1.2775 0.6029 -0.2289 0.0377 ...
#>   .. ..$ x2   : num [1:10] -0.923 -1.472 0.449 -1.178 0.192 ...
#>   .. ..$ group: chr [1:10] "female" "male" "female" "female" ...
#>   ..$ 3 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] 1.292 0.634 -0.626 0.41 -0.901 ...
#>   .. ..$ x2   : num [1:10] -0.8047 0.9703 -0.0422 -1.2755 -0.7552 ...
#>   .. ..$ group: chr [1:10] "female" "male" "female" "female" ...
#>   .. [list output truncated]
#>  $ :List of 10
#>   ..$ 1 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] 0.452 1.292 0.79 -0.18 0.34 ...
#>   .. ..$ x2   : num [1:10] -0.00514 -0.80473 1.22694 0.16022 -0.97202 ...
#>   .. ..$ group: chr [1:10] "female" "female" "female" "female" ...
#>   ..$ 2 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] 0.611 -0.9456 -0.3748 -0.6857 -0.0479 ...
#>   .. ..$ x2   : num [1:10] -1.405 0.47 -0.868 -0.982 -0.923 ...
#>   .. ..$ group: chr [1:10] "male" "female" "male" "female" ...
#>   ..$ 3 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] 0.5269 -0.9008 0.0845 0.4104 0.8517 ...
#>   .. ..$ x2   : num [1:10] -0.87 -0.755 0.786 -1.276 -0.947 ...
#>   .. ..$ group: chr [1:10] "female" "female" "female" "female" ...
#>   .. [list output truncated]
#>   [list output truncated]
...
#> Warning: data length is not a multiple of split variable
#> Warning: data length is not a multiple of split variable
#> Warning: UNRELIABLE VALUE: One of the ‘future.apply’ iterations (‘future_lapply-1’) unexpectedly generated random numbers without declaring so. There is a risk that those random numbers are not statistically sound and the overall results might be invalid. To fix this, specify 'future.seed=TRUE'. This ensures that proper, parallel-safe random numbers are produced via a parallel RNG method. To disable this check, use 'future.seed = NULL', or set option 'future.rng.onMisuse' to "ignore". [future ‘future_lapply-1’ (99a448e2ea783fecff0265fe4b85b4b5-19); on 99a448e2ea783fecff0265fe4b85b4b5@runnervm5mmn9<7595>]
...
#>   ..$ id: chr [1:100] "female" "female" "male" "female" ...
#>  $ :'data.frame':    100 obs. of  3 variables:
#>   ..$ x1: num [1:100] -0.242 -0.468 -0.773 2.15 -1.334 ...
#>   ..$ x2: num [1:100] 1.066 -0.536 0.536 -1.829 -1.814 ...
#>   ..$ id: chr [1:100] "female" "female" "female" "female" ...
#>  $ :'data.frame':    100 obs. of  3 variables:
#>   ..$ x1: num [1:100] -0.242 -0.468 -0.773 2.15 -1.334 ...
#>   ..$ x2: num [1:100] 1.066 -0.536 0.536 -1.829 -1.814 ...
