...
#>   ..$ imag1: int [1:250] 9 7 10 5 7 8 7 10 6 10 ...
#>   ..$ imag2: int [1:250] 9 7 10 5 8 8 7 10 5 10 ...
#>   ..$ imag3: int [1:250] 9 7 8 6 8 8 7 10 5 10 ...
#>   .. [list output truncated]
#>  $ :'data.frame':    250 obs. of  27 variables:
#>   ..$ imag1: int [1:250] 8 10 8 8 7 7 10 5 7 8 ...
#>   ..$ imag2: int [1:250] 8 10 5 4 9 7 0 5 8 9 ...
#>   ..$ imag3: int [1:250] 8 10 6 3 9 8 0 7 8 7 ...
#>   .. [list output truncated]
#>  $ :'data.frame':    250 obs. of  27 variables:
#>   ..$ imag1: int [1:250] 8 6 8 9 7 9 8 8 8 7 ...
#>   ..$ imag2: int [1:250] 8 8 8 10 9 9 6 8 5 7 ...
#>   ..$ imag3: int [1:250] 8 8 8 9 9 9 3 8 7 7 ...
#>   .. [list output truncated]
#>   [list output truncated]
...
#>   .. ..$ x1   : num [1:10] -0.266 -0.489 0.596 -2.399 1.377 ...
#>   .. ..$ x2   : num [1:10] 0.322 0.709 0.5492 0.0099 1.0919 ...
#>   .. ..$ group: chr [1:10] "female" "female" "male" "male" ...
#>   ..$ 2 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] -0.626 0.962 -0.23 1.292 -1.595 ...
#>   .. ..$ x2   : num [1:10] -0.0422 -0.0325 -0.4629 -0.8047 -0.2646 ...
#>   .. ..$ group: chr [1:10] "female" "female" "female" "female" ...
#>   ..$ 3 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] -0.319 0.611 -0.665 0.79 -0.264 ...
#>   .. ..$ x2   : num [1:10] -0.501 -1.405 0.96 1.227 -1.196 ...
#>   .. ..$ group: chr [1:10] "male" "male" "female" "female" ...
#>   .. [list output truncated]
#>  $ :List of 10
#>   ..$ 1 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] 0.20637 -0.75246 0.00705 0.30028 0.8539 ...
#>   .. ..$ x2   : num [1:10] 1.901 0.463 0.879 1.797 -0.99 ...
#>   .. ..$ group: chr [1:10] "male" "male" "male" "female" ...
#>   ..$ 2 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] -0.0479 0.6637 1.1175 0.1626 -0.084 ...
#>   .. ..$ x2   : num [1:10] -0.923 -0.113 -1.152 -0.576 -0.708 ...
#>   .. ..$ group: chr [1:10] "female" "male" "male" "female" ...
#>   ..$ 3 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] -0.9456 -0.2417 -0.9008 0.8517 -0.0469 ...
#>   .. ..$ x2   : num [1:10] 0.47 1.066 -0.755 -0.947 1.366 ...
#>   .. ..$ group: chr [1:10] "female" "female" "female" "male" ...
#>   .. [list output truncated]
#>  $ :List of 10
#>   ..$ 1 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] -0.242 -0.628 0.34 1.176 -1.093 ...
#>   .. ..$ x2   : num [1:10] 0.667 0.736 -0.972 -0.126 0.892 ...
#>   .. ..$ group: chr [1:10] "female" "male" "female" "female" ...
#>   ..$ 2 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] 0.6029 0.1837 0.4188 0.8517 0.0377 ...
#>   .. ..$ x2   : num [1:10] 0.449 2.375 0.212 -0.947 0.192 ...
#>   .. ..$ group: chr [1:10] "female" "female" "male" "male" ...
#>   ..$ 3 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] 0.903 0.41 -0.901 0.527 0.163 ...
#>   .. ..$ x2   : num [1:10] 2.454 -1.276 -0.405 -0.87 -0.576 ...
...
#> Warning: data length is not a multiple of split variable
#> Warning: data length is not a multiple of split variable
#> Warning: UNRELIABLE VALUE: One of the ‘future.apply’ iterations (‘future_lapply-1’) unexpectedly generated random numbers without declaring so. There is a risk that those random numbers are not statistically sound and the overall results might be invalid. To fix this, specify 'future.seed=TRUE'. This ensures that proper, parallel-safe random numbers are produced via a parallel RNG method. To disable this check, use 'future.seed = NULL', or set option 'future.rng.onMisuse' to "ignore". [future ‘future_lapply-1’ (70847eb85b73a06dc2fe165e95f5efb7-15); on 70847eb85b73a06dc2fe165e95f5efb7@runnervm76f27<7319>]
