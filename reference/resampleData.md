...
#>   ..$ imag1: int [1:250] 8 8 5 8 9 5 8 2 8 8 ...
#>   ..$ imag2: int [1:250] 8 9 6 9 9 5 8 2 9 8 ...
#>   ..$ imag3: int [1:250] 8 10 5 9 9 6 8 8 5 8 ...
#>   .. [list output truncated]
#>  $ :'data.frame':    250 obs. of  27 variables:
#>   ..$ imag1: int [1:250] 7 4 8 10 5 6 8 9 8 7 ...
#>   ..$ imag2: int [1:250] 9 8 10 10 5 6 8 9 8 4 ...
#>   ..$ imag3: int [1:250] 9 8 10 10 7 5 8 10 9 5 ...
#>   .. [list output truncated]
#>  $ :'data.frame':    250 obs. of  27 variables:
#>   ..$ imag1: int [1:250] 8 4 8 10 10 8 8 9 9 10 ...
#>   ..$ imag2: int [1:250] 10 8 7 10 10 8 10 8 7 10 ...
#>   ..$ imag3: int [1:250] 9 8 7 10 10 8 10 8 7 8 ...
#>   .. [list output truncated]
#>   [list output truncated]
...
#>   .. ..$ x1   : num [1:10] 0.611 -0.559 1.177 1.871 0.619 ...
#>   .. ..$ x2   : num [1:10] -1.405 -1.388 0.529 -1.049 0.314 ...
#>   .. ..$ group: chr [1:10] "male" "male" "male" "male" ...
#>   ..$ 2 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] 1.6465 -0.0479 -0.2417 -0.628 -0.735 ...
#>   .. ..$ x2   : num [1:10] -0.973 -0.923 1.066 0.736 -0.331 ...
#>   .. ..$ group: chr [1:10] "female" "female" "female" "male" ...
#>   ..$ 3 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] 0.41 -0.084 -0.768 -0.279 -0.393 ...
#>   .. ..$ x2   : num [1:10] -1.276 -0.708 -2.102 2.196 0.499 ...
#>   .. ..$ group: chr [1:10] "female" "female" "female" "female" ...
#>   .. [list output truncated]
#>  $ :List of 10
#>   ..$ 1 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] 0.1626 -0.773 0.0845 -0.7555 1.2923 ...
#>   .. ..$ x2   : num [1:10] -0.576 0.536 0.786 0.489 -0.805 ...
#>   .. ..$ group: chr [1:10] "female" "female" "female" "female" ...
#>   ..$ 2 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] -1.277 1.234 -0.375 0.419 0.382 ...
#>   .. ..$ x2   : num [1:10] -1.472 -0.564 -0.868 0.212 0.538 ...
#>   .. ..$ group: chr [1:10] "male" "female" "male" "male" ...
#>   ..$ 3 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] 0.962 -1.428 2.15 -0.261 -0.665 ...
#>   .. ..$ x2   : num [1:10] -0.0325 -0.2837 -1.8286 0.2863 0.9604 ...
#>   .. ..$ group: chr [1:10] "female" "male" "male" "female" ...
#>   .. [list output truncated]
#>  $ :List of 10
#>   ..$ 1 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] 0.852 -0.264 -0.901 0.419 -0.266 ...
#>   .. ..$ x2   : num [1:10] -0.947 -1.196 -0.405 0.212 0.322 ...
#>   .. ..$ group: chr [1:10] "male" "female" "male" "male" ...
#>   ..$ 2 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] -0.0469 0.0845 0.8375 0.5964 -0.4889 ...
#>   .. ..$ x2   : num [1:10] 1.366 0.786 0.796 0.549 0.709 ...
#>   .. ..$ group: chr [1:10] "female" "female" "female" "male" ...
#>   ..$ 3 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] 0.193 0.0749 0.5269 -0.628 -0.0062 ...
#>   .. ..$ x2   : num [1:10] -0.61 -0.81 -0.87 0.736 1.845 ...
...
#> Warning: data length is not a multiple of split variable
#> Warning: data length is not a multiple of split variable
#> Warning: UNRELIABLE VALUE: One of the ‘future.apply’ iterations (‘future_lapply-1’) unexpectedly generated random numbers without declaring so. There is a risk that those random numbers are not statistically sound and the overall results might be invalid. To fix this, specify 'future.seed=TRUE'. This ensures that proper, parallel-safe random numbers are produced via a parallel RNG method. To disable this check, use 'future.seed = NULL', or set option 'future.rng.onMisuse' to "ignore". [future ‘future_lapply-1’ (e87e41ce10cb14ebcdfd107a9473f3d0-18); on e87e41ce10cb14ebcdfd107a9473f3d0@runnervmgx7h7<7403>]
...
#>   ..$ x1: num [1:100] -0.242 -0.468 -0.773 2.15 -1.334 ...
#>   ..$ x2: num [1:100] 1.066 -0.536 0.536 -1.829 -1.814 ...
#>   ..$ id: chr [1:100] "female" "female" "female" "male" ...
#>   [list output truncated]
