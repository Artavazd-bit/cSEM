...
#>   ..$ imag1: int [1:250] 7 8 9 7 7 8 8 8 10 9 ...
#>   ..$ imag2: int [1:250] 8 8 9 9 9 5 8 8 10 10 ...
#>   ..$ imag3: int [1:250] 7 8 9 8 9 7 8 3 10 9 ...
#>   .. [list output truncated]
#>  $ :'data.frame':    250 obs. of  27 variables:
#>   ..$ imag1: int [1:250] 5 6 10 10 7 7 8 8 8 9 ...
#>   ..$ imag2: int [1:250] 5 8 8 10 7 8 9 5 7 9 ...
#>   ..$ imag3: int [1:250] 7 8 8 10 7 9 9 9 8 9 ...
#>   .. [list output truncated]
#>  $ :'data.frame':    250 obs. of  27 variables:
#>   ..$ imag1: int [1:250] 9 10 10 10 8 8 8 7 9 6 ...
#>   ..$ imag2: int [1:250] 10 0 10 9 8 8 8 7 9 8 ...
#>   ..$ imag3: int [1:250] 10 0 10 9 8 8 8 8 9 8 ...
#>   .. [list output truncated]
#>   [list output truncated]
...
#>   .. ..$ x1   : num [1:10] -0.2303 -0.0887 -0.2289 -0.7136 0.2064 ...
#>   .. ..$ x2   : num [1:10] -0.463 -1.388 -1.178 0.74 1.901 ...
#>   .. ..$ group: chr [1:10] "female" "female" "female" "female" ...
#>   ..$ 2 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] -0.665 -0.468 -1.334 0.634 0.837 ...
#>   .. ..$ x2   : num [1:10] 0.96 -0.536 -1.814 0.97 0.796 ...
#>   .. ..$ group: chr [1:10] "female" "female" "female" "male" ...
#>   ..$ 3 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] -0.735 -0.977 0.163 -1.568 -0.489 ...
#>   .. ..$ x2   : num [1:10] -0.331 0.693 -0.576 2.708 0.709 ...
#>   .. ..$ group: chr [1:10] "female" "male" "female" "male" ...
#>   .. [list output truncated]
#>  $ :List of 10
#>   ..$ 1 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] 0.34 0.629 -0.261 2.15 0.419 ...
#>   .. ..$ x2   : num [1:10] -0.972 -0.14 0.286 -1.829 0.212 ...
#>   .. ..$ group: chr [1:10] "female" "male" "female" "male" ...
#>   ..$ 2 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] 1.177 0.441 0.412 -0.393 0.496 ...
#>   .. ..$ x2   : num [1:10] 0.529 0.9717 -0.0186 0.4993 1.3726 ...
#>   .. ..$ group: chr [1:10] "male" "male" "male" "female" ...
#>   ..$ 3 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] -0.6857 -0.2793 -0.242 1.7637 -0.0887 ...
#>   .. ..$ x2   : num [1:10] -0.982 2.196 0.667 0.37 -1.388 ...
#>   .. ..$ group: chr [1:10] "female" "female" "female" "female" ...
#>   .. [list output truncated]
#>  $ :List of 10
#>   ..$ 1 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] -0.0062 0.6344 0.6193 -2.3992 0.8539 ...
#>   .. ..$ x2   : num [1:10] 1.8448 0.9703 0.3142 0.0099 -0.9897 ...
#>   .. ..$ group: chr [1:10] "female" "male" "male" "male" ...
#>   ..$ 2 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] 0.486 -0.489 0.41 -0.901 -0.319 ...
#>   .. ..$ x2   : num [1:10] -0.462 0.709 -1.276 -0.405 -0.501 ...
#>   .. ..$ group: chr [1:10] "male" "female" "female" "male" ...
#>   ..$ 3 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] 1.292 0.596 -0.152 -0.266 1.764 ...
#>   .. ..$ x2   : num [1:10] -0.805 0.549 2.011 0.322 0.37 ...
...
#> Warning: data length is not a multiple of split variable
#> Warning: data length is not a multiple of split variable
#> Warning: UNRELIABLE VALUE: One of the ‘future.apply’ iterations (‘future_lapply-1’) unexpectedly generated random numbers without declaring so. There is a risk that those random numbers are not statistically sound and the overall results might be invalid. To fix this, specify 'future.seed=TRUE'. This ensures that proper, parallel-safe random numbers are produced via a parallel RNG method. To disable this check, use 'future.seed = NULL', or set option 'future.rng.onMisuse' to "ignore". [future ‘future_lapply-1’ (c1a93df185a4e57e83050d8d347f7a7a-15); on c1a93df185a4e57e83050d8d347f7a7a@runnervm3jd5f<7259>]
...
#>   ..$ id: chr [1:100] "male" "male" "male" "female" ...
#>  $ :'data.frame':    100 obs. of  3 variables:
#>   ..$ x1: num [1:100] -0.242 -0.468 -0.773 2.15 -1.334 ...
#>   ..$ x2: num [1:100] 1.066 -0.536 0.536 -1.829 -1.814 ...
