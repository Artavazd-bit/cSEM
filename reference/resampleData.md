...
#>   ..$ imag1: int [1:250] 0 6 8 8 5 8 8 9 10 8 ...
#>   ..$ imag2: int [1:250] 4 6 10 7 6 9 7 9 10 8 ...
#>   ..$ imag3: int [1:250] 7 6 9 8 5 9 6 9 10 9 ...
#>   .. [list output truncated]
#>  $ :'data.frame':    250 obs. of  27 variables:
#>   ..$ imag1: int [1:250] 8 9 10 10 5 9 8 8 6 8 ...
#>   ..$ imag2: int [1:250] 9 9 10 10 8 9 8 8 7 8 ...
#>   ..$ imag3: int [1:250] 9 9 10 8 8 9 9 8 7 9 ...
#>   .. [list output truncated]
#>  $ :'data.frame':    250 obs. of  27 variables:
#>   ..$ imag1: int [1:250] 9 9 9 7 7 10 9 6 6 8 ...
#>   ..$ imag2: int [1:250] 7 9 9 9 9 10 9 7 7 8 ...
#>   ..$ imag3: int [1:250] 7 9 10 9 9 10 10 7 7 8 ...
#>   .. [list output truncated]
#>   [list output truncated]
...
#>   .. ..$ x1   : num [1:10] 0.34 0.6637 0.7936 -0.6259 -0.0062 ...
#>   .. ..$ x2   : num [1:10] -0.972 -0.1128 0.3624 -0.0422 1.8448 ...
#>   .. ..$ group: chr [1:10] "female" "male" "male" "female" ...
#>   ..$ 2 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] 0.4188 1.2923 -0.5585 -1.2613 -0.0479 ...
#>   .. ..$ x2   : num [1:10] 0.212 -0.805 -1.388 -1.649 -0.923 ...
#>   .. ..$ group: chr [1:10] "male" "female" "male" "male" ...
#>   ..$ 3 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] -0.152 -0.946 -0.783 0.163 0.412 ...
#>   .. ..$ x2   : num [1:10] 2.0113 0.4699 -0.2047 -0.5763 -0.0186 ...
#>   .. ..$ group: chr [1:10] "male" "female" "female" "female" ...
#>   .. [list output truncated]
#>  $ :List of 10
#>   ..$ 1 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] 1.1849 -0.779 0.0377 -0.1804 -2.3483 ...
#>   .. ..$ x2   : num [1:10] -0.161 0.975 0.192 0.16 -0.341 ...
#>   .. ..$ group: chr [1:10] "male" "male" "female" "female" ...
#>   ..$ 2 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] 0.9618 -0.4636 0.611 -0.0193 -1.5677 ...
#>   .. ..$ x2   : num [1:10] -0.0325 -0.5351 -1.4053 -0.4089 2.7082 ...
#>   .. ..$ group: chr [1:10] "female" "male" "male" "female" ...
#>   ..$ 3 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] 0.596 -1.277 0.634 0.3 -0.261 ...
#>   .. ..$ x2   : num [1:10] 0.549 -1.472 0.97 1.797 0.286 ...
#>   .. ..$ group: chr [1:10] "male" "male" "male" "female" ...
#>   .. [list output truncated]
#>  $ :List of 10
#>   ..$ 1 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] 0.3003 0.6344 1.6465 -0.0479 -0.0193 ...
#>   .. ..$ x2   : num [1:10] 1.797 0.97 -0.973 -0.923 -0.409 ...
#>   .. ..$ group: chr [1:10] "female" "male" "female" "female" ...
#>   ..$ 2 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] 0.1837 -0.7662 -0.3748 -1.0934 -0.0469 ...
#>   .. ..$ x2   : num [1:10] 2.375 -0.386 -0.868 0.892 1.366 ...
#>   .. ..$ group: chr [1:10] "female" "male" "male" "female" ...
#>   ..$ 3 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] -0.735 0.441 -0.946 0.206 -0.264 ...
#>   .. ..$ x2   : num [1:10] -0.331 0.972 0.47 1.901 -1.196 ...
#>   .. ..$ group: chr [1:10] "female" "male" "female" "male" ...
#>   .. [list output truncated]
#>   [list output truncated]
...
#> Warning: data length is not a multiple of split variable
#> Warning: data length is not a multiple of split variable
#> Warning: UNRELIABLE VALUE: One of the ‘future.apply’ iterations (‘future_lapply-1’) unexpectedly generated random numbers without declaring so. There is a risk that those random numbers are not statistically sound and the overall results might be invalid. To fix this, specify 'future.seed=TRUE'. This ensures that proper, parallel-safe random numbers are produced via a parallel RNG method. To disable this check, use 'future.seed = NULL', or set option 'future.rng.onMisuse' to "ignore". [future ‘future_lapply-1’ (561ba48ea231ba1f7db47f5821924838-16); on 561ba48ea231ba1f7db47f5821924838@runnervmvrwv9<7613>]
...
#>   ..$ id: chr [1:100] "male" "male" "male" "male" ...
#>  $ :'data.frame':    100 obs. of  3 variables:
#>   ..$ x1: num [1:100] -0.242 -0.468 -0.773 2.15 -1.334 ...
#>   ..$ x2: num [1:100] 1.066 -0.536 0.536 -1.829 -1.814 ...
